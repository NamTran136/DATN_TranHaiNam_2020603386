        ...
        public static async Task InitializeAsync(DataDbContext db)
        {
            ...
            if(!db.Users.Any())
            {
                ...
                var admin = new User
                {
                    ...
                    ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXPodEp1Zyixlyx1Rrq6JJlPm0hgg1pFeLNrxgt2bkYw&s",
                    IsAdmin = true,
                    Point = 1000000
                };
                db.Users.Add(admin);
            ...
            var book1 = new Book
            {
                ...
                ImageUrl = "https://nhasachmienphi.com/images/thumbnail/nhasachmienphi-kho-tang-truyen-co-tich-viet-nam.jpg",
                IsPrivate = true,
                Language = "Tiếng Việt",
                Category = category1
            };
            var book2 = new Book
            {
                ...
                ImageUrl = "https://nhasachmienphi.com/images/thumbnail/nhasachmienphi-than-thoai-hy-lap.jpg",
                IsPrivate = false,
                Language = "Tiếng Việt",
                Category = category1
            };
            var book3 = new Book
            {
                ...
                ImageUrl = "https://nhasachmienphi.com/images/thumbnail/nhasachmienphi-truyen-co-andersen.jpg",
                IsPrivate = false,
                Language = "Tiếng Việt",
                Category = category1
            };
            var book4 = new Book
            {
                ...
                ImageUrl = "https://nhasachmienphi.com/images/thumbnail/nhasachmienphi-su-im-lang-cua-bay-cuu.jpg",
                IsPrivate = true,
                Language = "Tiếng Việt",
                Category = category2
            };
